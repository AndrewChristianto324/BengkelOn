                ...
                children: <Widget>[
                  ...
                  FadeAnimation(1.4, Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        RaisedButton (
                        child: makeItem(image: 'assets/images/Italy.jpg', title: 'BSD'),
                        onPressed: (){
                          Navigator.pushNamed(context, ListBengkel.routeName);
                        },
                         ),
                         RaisedButton (
                        child: makeItem(image: 'assets/images/canada.jpg', title: 'Gading Serpong'),
                        onPressed: (){
                          Navigator.pushNamed(context, ListBengkel.routeName);
                        },
                         ),
                         RaisedButton(
                        child: makeItem(image: 'assets/images/greece.jpg', title: 'Cikokol'),
                        onPressed: (){
                          Navigator.pushNamed(context, ListBengkel.routeName);
                        },
                         ),
                         RaisedButton(
                        child: makeItem(image: 'assets/images/united-states.jpg', title: 'Karawaci'),
                        onPressed: (){
                          Navigator.pushNamed(context, ListBengkel.routeName);
                        },
                         ),
